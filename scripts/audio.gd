...
const CATALOG := {
	...
	# The ship coming back to life and leaving (see ship_wake.gd), generated by
	# tools/make_ship_sounds.py. Throttled so a flurry of repairs cannot stack
	# the same sound on itself.
	"ship_power_on": {"files": [SHIP + "power_on.wav"], "db": -4.0, "pitch": 0.0, "throttle": 800},
	"ship_air": {"files": [SHIP + "air.wav"], "db": -8.0, "pitch": 0.04, "throttle": 1500},
