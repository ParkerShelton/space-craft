...
const DEFS := [
	...
	{"id": "ring", "name": "What Can I Make?", "parent": "wood", "tab": "survival",
		"desc": "Open the build ring and see what wood is for.",
		"icon": "CARPENTER"},
	{"id": "bench", "name": "Somewhere to Work", "parent": "ring", "tab": "survival",
